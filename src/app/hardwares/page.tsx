      ...
      <section className="py-16 lg:py-20 bg-[#D97D55] text-white">
        <div className="container-custom">
          <div className="text-center">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold">Equip your team with reliable hardware</h2>
            <p className="mt-3 text-white/90 max-w-2xl mx-auto">
              Request a quick quote or talk to our specialists. Simple process, real results.
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <CheckCircleIcon className="w-5 h-5 mr-2" /> Get Free Quote
              </a>
              <a
                href="/contact"
